/**
  ...
  lightweight greeter (regreet, tuigreet) is a greetd frontend and inherits
  the same behaviour. plasma-login-manager, by contrast, runs a real PAM auth
  stack for autologin — `plasmalogin-autologin`, patched below.
